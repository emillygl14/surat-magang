  ...
  return (
    <>
      <header className="bg-white border-b border-gray-200 px-4 sm:px-8 h-14 sm:h-16 flex items-center justify-between shrink-0">
        <h1 className="text-base sm:text-xl font-bold text-gray-900">Dashboard Admin</h1>
      ...
      <main className="flex-1 p-4 sm:p-8">
        <div className="mb-4 sm:mb-6">
          ...
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Admin Jurusan Teknik Elektro</h2>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6 sm:mb-8">
          ...
          <StatCard label="Selesai" value={counts.selesai} desc="Surat telah diunggah" icon={<BsCheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-green-600" />} iconBg="bg-green-50" />
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-2xl shadow-sm">
          ...
          <div className="sm:hidden">
            {recent.length === 0 ? (
              <div className="py-12 text-center text-gray-400 text-sm">Belum ada pengajuan masuk.</div>
            ) : (
                  ...
                  <div key={p.id} className="px-4 py-3.5">
                    <div className="flex items-start justify-between gap-2 mb-1">
                      <div>
                        ...
                        <p className="text-xs text-gray-500">{p.jenisSurat}</p>
                      </div>
